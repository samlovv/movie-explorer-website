  ...
  return (
    <main className="w-full text-white">
      ...
      <div className="relative w-full h-[200px] sm:h-[350px] md:h-[500px]">
        ...
        {/* Градиент и blur для читаемости */}
        <div className="absolute inset-0 bg-gradient-to-t from-black/95 via-black/60 to-transparent backdrop-blur-sm" />

        {/* POSTER */}
        <div className="absolute left-[80px] bottom-[-100px] sm:left-12 sm:bottom-[-180px] md:left-24 md:bottom-[-260px] transform -translate-x-1/2 sm:translate-x-0">
          <img
            src={
              movie.poster_path
            ...
            alt={title}
            className="w-26 sm:w-45 md:w-54 lg:w-64 rounded-xl shadow-2xl"
          />
        </div>
      </div>

      {/* MOVIE INFO */}
      <div className="mt-13 sm:mt-20 md:mt-27 lg:mt-72 xl:mt-16 xl:ml-93 px-4 sm:px-6 md:px-12  ">
        <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold ml-35 sm:ml-55 md:ml-72 lg:ml-0 mb-4 sm:mb-20 md:mb-30 lg:mb-10">{title}</h1>
        ...
        <div className="flex flex-wrap gap-3 mb-6">
          ...
          {movie.genres.map((genre: Genre) => (
            <Link
              ...
              className="bg-red-600/90 text-white px-3 py-1 rounded-full hover:bg-red-500 transition text-sm"
            >
              {genre.name}
            </Link>
          ))}
      ...
      {/* TRAILER */}
      {trailer && (
        <section className="mt-12 sm:mt-16 md:mt-20 px-4 sm:px-6 md:px-12">
        ...
        <section className="mt-12 px-4 sm:px-6 md:px-12">
          ...
          <div className="mt-6">
            <Link
              ...
              className="inline-block px-5 py-2 bg-red-600 text-white rounded-lg hover:bg-red-500 transition font-semibold text-sm sm:text-base"
            >
              Full Cast →
            </Link>
          </div>
      ...
      {/* SIMILAR */}
      {similar.length > 0 && (
        <section className="mt-12 px-4 sm:px-6 md:px-12 mb-12">
              ...
              {similar.map((item: any) => {
                ...
                return (
                  <Link
                    ...
                    className="group movie-card snap-start min-w-[120px] sm:min-w-[140px] md:min-w-[180px] flex-shrink-0 bg-gray-900 rounded-xl overflow-hidden shadow-lg relative transform transition duration-300 hover:scale-105"
                  >
                    ...
                    <img
                      ...
                      alt={simTitle}
                      className="w-full h-[180px] sm:h-[200px] md:h-[270px] object-cover"
                    />
